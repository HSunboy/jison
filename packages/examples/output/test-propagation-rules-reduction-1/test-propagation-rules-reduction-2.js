 ...
 */
            ...
            var testPropagationRulesReduction_2 = (function () {
...
var parser = {
    ...
    //   parser table compression mode: ... 0
...
case 5:
    /*! Production::    expressions : WORD */

    this.$ = yyvstack[yysp];
    break;

default:
                // default action for all unlisted resolve states: 1, 2, 3, 4
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 3 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = testPropagationRulesReduction_2;
  exports.Parser = testPropagationRulesReduction_2.Parser;
  exports.parse = function () {
    return testPropagationRulesReduction_2.parse.apply(testPropagationRulesReduction_2, arguments);
  };
