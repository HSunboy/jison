...
case 5:
    /*! Production::    line : exp NL */

    console.log('line: ', JSON.stringify(yyvstack[yysp - 1], null, 2)); 
    
    this.$ = yyvstack[yysp - 1].concat( /* NL */ 13);
    break;

case 6:
    /*! Production::    line : error NL */
...
case 7:
    ...
    this.$ = [- /* NUM */ 14, yyvstack[yysp]];
    break;

case 8:
    /*! Production::    exp : CONSTANT */

    this.$ = [- /* CONSTANT */ 15, yyvstack[yysp]];
    break;

case 9:
    /*! Production::    exp : VAR */

    this.$ = [- /* VAR */ 16, yyvstack[yysp]];
    break;

case 10:
    /*! Production::    exp : VAR "=" exp */

    this.$ = [ /* = */ 3, - /* VAR */ 16, yyvstack[yysp - 2]].concat(yyvstack[yysp]);
    break;

case 11:
    /*! Production::    exp : FUNCTION "(" ")" */

    this.$ = [- /* FUNCTION */ 17, yyvstack[yysp - 2],  /* END */ 21];
    break;

case 12:
    /*! Production::    exp : FUNCTION "(" arglist ")" */

    this.$ = [- /* FUNCTION */ 17, yyvstack[yysp - 3]].concat(yyvstack[yysp - 1],  /* END */ 21);
    break;

case 13:
    /*! Production::    exp : exp "+" exp */

    this.$ = [ /* + */ 6].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 14:
    /*! Production::    exp : exp "-" exp */

    this.$ = [ /* - */ 7].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 15:
    /*! Production::    exp : exp "*" exp */

    this.$ = [ /* * */ 8].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 16:
    /*! Production::    exp : exp "/" exp */

    this.$ = [ /* / */ 9].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 17:
    /*! Production::    exp : "-" exp */

    this.$ = [ /* UMINUS */ 19].concat(yyvstack[yysp]);
    break;

case 18:
    /*! Production::    exp : "+" exp */

    this.$ = [ /* UPLUS */ 20].concat(yyvstack[yysp]);
    break;

case 19:
    /*! Production::    exp : exp POWER exp */

    this.$ = [ /* POWER */ 18].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 20:
    /*! Production::    exp : exp "%" */

    this.$ = [ /* % */ 10].concat(yyvstack[yysp - 1]);
    break;

case 21:
    /*! Production::    exp : exp "!" */

    this.$ = [ /* ! */ 11].concat(yyvstack[yysp - 1]);
    break;
...
case 24:
    /*! Production::    arglist : exp "," arglist */

    this.$ = [ /* , */ 12].concat(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 41:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 41 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 4:
        ...
        if (rv) {
          ...
          if (rv.opcode) {
            yy_.yytext = new Visyond.FormulaParser.ASTopcode(rv.opcode).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(rv.name);
          } else if (rv.lexer_opcode) {
            yy_.yytext = new Visyond.FormulaParser.lexerToken(rv.lexer_opcode).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(rv.name);
          }
        ...
        if (rv) {
          yy_.yytext = new Visyond.FormulaParser.ASTcurrency.ASTcurrency(rv).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(s);
          return 'CURRENCY';
        }
        ...
        if (rv) {
          yy_.yytext = new Visyond.FormulaParser.ASTvalue(rv.value, rv.attributes).setPredefinedConstantInfo(rv).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(s);
      ...
      case 5:
        ...
        yy_.yytext = new Visyond.FormulaParser.ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_2039).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      ...
      case 6:
        ...
        yy_.yytext = new Visyond.FormulaParser.ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_201C).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      ...
      case 7:
        ...
        yy_.yytext = new Visyond.FormulaParser.ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_00AB).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      ...
      case 8:
        ...
        yy_.yytext = new Visyond.FormulaParser.ASTvalue(s2, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_SINGLEQUOTE).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      ...
      case 9:
        ...
        s2 = parser.dedupQuotedString(s, '"');
        yy_.yytext = new Visyond.FormulaParser.ASTvalue(s2, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_DOUBLEQUOTE).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      ...
      case 13:
        ...
        yy_.yytext = new Visyond.FormulaParser.ASTerror(FERR_UNTERMINATED_INLINE_COMMENT, 'Unterminated inline comment.').setErrorArguments(this.inline_comment_end_markers).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(yy_.yytext);
        return 2;
        break;
    ...
    rules: [
      ...
      /*  2: */  /^(?:\d+(?:[Ee][-+]*\d+)?\b)/,
      /*  3: */  /^(?:[^\W\d]+\w*\b)/,
      /*  4: */  new XRegExp('^(?:([^\\p{Alphabetic}\\p{Number}\\s_]{1,3}))', ''),
      /*  5: */  /^(?:\u2039([^›]*)\u203a)/,
      /*  6: */  /^(?:\u201c([^”]*)\u201d)/,
      /*  7: */  /^(?:\u00ab([^»]*)\u00bb)/,
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = unicode2;
  exports.Parser = unicode2.Parser;
  exports.parse = function () {
    return unicode2.parse.apply(unicode2, arguments);
  };
