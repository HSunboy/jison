 ...
 */
            ...
            var parserToLexerCommunicationTest = (function () {
...
case 10:
    ...
    yyparser.yyErrOk(); yyparser.yyClearIn(); this.$ = 'ERROR';
    break;

case 11:
    /*! Production::    a : A */

    this.$ = ('A[' + yyvstack[yysp] + ']');
    break;

case 12:
    /*! Production::    f_a : A lb e rb */

    this.$ = ('A' + yyvstack[yysp - 2] + yyvstack[yysp - 1] + yyvstack[yysp]);
    break;

case 13:
    /*! Production::    b : B */

    this.$ = ('B[' + yyvstack[yysp] + ']');
    break;

case 14:
    /*! Production::    f_b : B lb e rb */

    this.$ = ('B' + yyvstack[yysp - 2] + yyvstack[yysp - 1] + yyvstack[yysp]);
    break;

case 15:
    /*! Production::    lb : "(" */

    yylexer.pushState('alt'); this.$ = '(';
    break;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = parserToLexerCommunicationTest;
  exports.Parser = parserToLexerCommunicationTest.Parser;
  exports.parse = function () {
    return parserToLexerCommunicationTest.parse.apply(parserToLexerCommunicationTest, arguments);
  };
