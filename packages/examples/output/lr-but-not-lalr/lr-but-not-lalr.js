...
parser.main = function () {
    var rv = parser.parse('d a');
    console.log("#1 ==> ", rv);
    assert.deepEqual(rv, ["A", "a"]);

    rv = parser.parse('b d c');
    console.log("#2 ==> ", rv);
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = lrButNotLalr;
  exports.Parser = lrButNotLalr.Parser;
  exports.parse = function () {
    return lrButNotLalr.parse.apply(lrButNotLalr, arguments);
  };
