...
case 1:
    /*! Production::    expressions : X BUGGY EOF */

    this.$ = yyvstack[yysp - 2] + 'B:' + yyvstack[yysp - 1] + 'E:' + yyvstack[yysp];
    break;
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 5 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = testEOFBugfix;
  exports.Parser = testEOFBugfix.Parser;
  exports.parse = function () {
    return testEOFBugfix.parse.apply(testEOFBugfix, arguments);
  };
