...
case 2:
    /*! Production::    instlist : label COLON inst instlist */
case 5:
...
case 3:
    /*! Production::    instlist : inst instlist */
case 14:
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 53 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = dism;
  exports.Parser = dism.Parser;
  exports.parse = function () {
    return dism.parse.apply(dism, arguments);
  };
