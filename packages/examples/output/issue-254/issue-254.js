...
symbols_: {
  ...
  "expression": 10,
  "function_call": 9,
  "function_call_option": 12,
  "function_call_option_repetition": 11,
  "test": 8
},
terminals_: {
  1: "EOF",
...
case 2:
    /*! Production::    function_call : IDENTIFIER "(" function_call_option ")" */

    console.log(yyvstack[yysp - 3]);
    console.log(yyvstack[yysp - 1]);
    ...
    //       1       2       3       4       
    this.$ = yyvstack[yysp - 3] + ':' + yyvstack[yysp - 2] + JSON.stringify(yyvstack[yysp - 1]) + yyvstack[yysp];
    break;
...
case 5:
    /*! Production::    function_call_option_repetition : %epsilon */

    this.$ = [];
    break;

case 6:
    /*! Production::    function_call_option_repetition : function_call_option_repetition "," expression */
...
case 7:
    /*! Production::    function_call_option : %epsilon */

    this.$ = undefined;
    break;

case 8:
    /*! Production::    function_call_option : expression function_call_option_repetition */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 13 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = issue_254;
  exports.Parser = issue_254.Parser;
  exports.parse = function () {
    return issue_254.parse.apply(issue_254, arguments);
  };
