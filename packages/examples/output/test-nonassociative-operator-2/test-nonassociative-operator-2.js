 ...
 */
            ...
            var testNonassociativeOperator_2 = (function () {
...
case 1:
    ...
    this.$ = parser.pop_all_markers() + ' ' + yyvstack[yysp - 2] + ' :' + yyvstack[yysp - 1] + ' ( ' + yyvstack[yysp] + ' )';
    break;

case 2:
    /*! Production::    e : WORD */

    this.$ = parser.pop_all_markers() + yyvstack[yysp];
    break;

case 3:
    /*! Production::    e : e error WORD */

    this.$ = parser.pop_all_markers() + yyvstack[yysp - 2] + ' ERR2: ' + yyvstack[yysp - 1] + ' CONT: ' + yyvstack[yysp];
    break;

case 4:
    /*! Production::    e : error */

    this.$ = parser.pop_all_markers() + ' ERR1: ' + yyvstack[yysp];
    break;

case 5:
    /*! Production::    epsilon : %epsilon */

    this.$ = parser.pop_all_markers() + 'ε';
    break;

case 6:
    /*! Production::    expressions : epsilon epsilon e */

    this.$ = parser.pop_all_markers() + yyvstack[yysp - 2] + yyvstack[yysp - 1] + yyvstack[yysp];
    break;

case 11:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 11 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
parser.main = function () {
    ...
    assert.equal(rv, "εε_o_w wa := ( a )");

    rv = parser.parse("a = a = a");
    console.log("\n\n  a = a = a ==> ", rv);

    assert.equal(rv, "εε_o_w _o_w wa := ( a ) := ( a )");
    // read as:
    // - reduce epsilon,
    // - reduce epsilon,
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = testNonassociativeOperator_2;
  exports.Parser = testNonassociativeOperator_2.Parser;
  exports.parse = function () {
    return testNonassociativeOperator_2.parse.apply(testNonassociativeOperator_2, arguments);
  };
