 ...
 */
            ...
            var errorHandlingAndYyerrokPart4a = (function () {
...
performAction: function parser__PerformAction(yystate /* action[1] */) {
          ...
          switch (yystate) {
case 0:
    /*! Production::    $accept : seq $end */
case 1:
    /*! Production::    seq : %epsilon */
case 3:
    /*! Production::    seq : seq error */

    
    break;

case 2:
    /*! Production::    seq : seq ZZ */

    yyparser.yyErrOk();
    break;

case 4:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 4 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = errorHandlingAndYyerrokPart4a;
  exports.Parser = errorHandlingAndYyerrokPart4a.Parser;
  exports.parse = function () {
    return errorHandlingAndYyerrokPart4a.parse.apply(errorHandlingAndYyerrokPart4a, arguments);
  };
