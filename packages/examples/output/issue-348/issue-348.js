...
symbols_: {
  ...
  "error": 2,
  "maxSelectAttr": 45,
  "maxSelectAttr_group": 60,
  "mcms": 37,
  "minSelectAttr": 47,
  "minSelectAttr_group": 62,
  "moreAttributes": 40,
  "moreOptions": 51,
  "moreScores": 57,
  "nameAttr": 42,
...
case 1:
    /*! Production::    mcms : DEFINE TYPE withRule AS stem options scores done */
    ...
    setType(yyvstack[yysp - 6]);
    break;

case 2:
    /*! Production::    withRule : %epsilon */
case 4:
    /*! Production::    attributeList : %epsilon */
case 6:
    /*! Production::    moreAttributes : %epsilon */
case 19:
    /*! Production::    stem : %epsilon */
case 23:
    /*! Production::    moreOptions : %epsilon */
case 31:
    /*! Production::    moreScores : %epsilon */
...
case 3:
    /*! Production::    withRule : WITH attributeList */
case 5:
    /*! Production::    attributeList : attribute moreAttributes */
case 7:
    /*! Production::    moreAttributes : "," attribute */
case 21:
    /*! Production::    options : anOption moreOptions */
case 27:
    /*! Production::    scores : aScore moreScores */
...
case 8:
    /*! Production::    attribute : nameAttr */
case 9:
    /*! Production::    attribute : orientAttr */
case 10:
    /*! Production::    attribute : minSelectAttr */
case 11:
    /*! Production::    attribute : maxSelectAttr */
case 14:
    /*! Production::    equals : "=" */
case 15:
    /*! Production::    equals : IS */
case 24:
    /*! Production::    moreOptions : options */
case 32:
    /*! Production::    moreScores : scores */
...
case 12:
    /*! Production::    nameAttr : NAME equals STRING */
    ...
    addAttribute("name", yyvstack[yysp]);
    break;

case 13:
    /*! Production::    orientAttr : ORIENTATION equals o */
    ...
    addAttribute("orientation", yyvstack[yysp]);
    break;

case 16:
    /*! Production::    maxSelectAttr : maxSelectAttr_group selectSpec */
    ...
    addAttribute("maxSelect", yyvstack[yysp]);
    break;

case 17:
    /*! Production::    selectSpec : selectSpec_group equals NUMBER */
case 34:
    /*! Production::    o : HORIZONTAL */
case 35:
    /*! Production::    o : VERTICAL */
case 36:
    /*! Production::    maxSelectAttr_group : MAX */
case 37:
    /*! Production::    maxSelectAttr_group : MAXIMUM */
case 38:
    /*! Production::    selectSpec_group : SELECT */
case 39:
    /*! Production::    selectSpec_group : SELECTION */
case 40:
    /*! Production::    minSelectAttr_group : MIN */
case 41:
    /*! Production::    minSelectAttr_group : MINIMUM */
case 42:
    /*! Production::    pointSpec_group : POINT */
case 43:
    /*! Production::    pointSpec_group : POINTS */
case 45:
    /*! Production::    cr_group : EXACTLY */
case 46:
    /*! Production::    cr_group : ANY */
case 47:
    /*! Production::    cr : ALL */
...
case 18:
    /*! Production::    minSelectAttr : minSelectAttr_group selectSpec */
    ...
    addAttribute("minSelect", yyvstack[yysp]);
    break;

case 20:
    /*! Production::    stem : STEM TEXT equals STRING */
    ...
    setStem(yyvstack[yysp]);
    break;

case 22:
    /*! Production::    anOption : OPTION TEXT equals STRING correctSpec */
    ...
    addOption(yyvstack[yysp - 1], yyvstack[yysp]);
    break;

case 25:
    /*! Production::    correctSpec : %epsilon */

    this.$ = false;
    break;

case 26:
    /*! Production::    correctSpec : AND IS CORRECT */

    this.$ = true;
    break;

case 28:
    /*! Production::    aScore : SCORE pointSpec FOR quantity */
    ...
    addScore(yyvstack[yysp - 2], yyvstack[yysp].scoreCriteria, yyvstack[yysp].numCorrect);
    break;

case 29:
    /*! Production::    pointSpec : NUMBER pointSpec_group */

    this.$ = yyvstack[yysp - 1];
    break;

case 30:
    /*! Production::    quantity : cr CORRECT */

    this.$ = {scoreCriteria: yyvstack[yysp - 1], numCorrect: yyvstack[yysp]};
    break;

case 33:
    /*! Production::    done : END TYPE */
...
case 44:
    /*! Production::    cr_group : AT LEAST */
case 48:
    /*! Production::    cr : cr_group NUMBER */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 80 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = issue_348;
  exports.Parser = issue_348.Parser;
  exports.parse = function () {
    return issue_348.parse.apply(issue_348, arguments);
  };
