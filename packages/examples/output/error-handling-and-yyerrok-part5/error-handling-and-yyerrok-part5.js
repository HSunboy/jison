 ...
 */
            ...
            var errorHandlingAndYyerrokPart5 = (function () {
...
case 14:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 14 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = errorHandlingAndYyerrokPart5;
  exports.Parser = errorHandlingAndYyerrokPart5.Parser;
  exports.parse = function () {
    return errorHandlingAndYyerrokPart5.parse.apply(errorHandlingAndYyerrokPart5, arguments);
  };
