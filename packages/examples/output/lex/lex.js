...
case 1:
    /*! Production::    lex : definitions include "%%" rules "%%" EOF */

    this.$ = {macros: yyvstack[yysp - 5], rules: yyvstack[yysp - 2]};
    if (yyvstack[yysp - 4]) this.$.actionInclude = yyvstack[yysp - 4];
    return this.$;
    break;
...
case 2:
    ...
    this.$ = {macros: yyvstack[yysp - 4], rules: yyvstack[yysp - 1]};
    if (yyvstack[yysp - 3]) this.$.actionInclude = yyvstack[yysp - 3];
    return this.$;
    break;

case 3:
    /*! Production::    include : action */
case 19:
    /*! Production::    regex_list : regex_chain */
case 28:
...
case 5:
    ...
    this.$ = yyvstack[yysp - 1]; this.$.concat(yyvstack[yysp]);
    break;

case 6:
    /*! Production::    definitions : definition */
case 10:
...
case 13:
    /*! Production::    regex : start_caret regex_list end_dollar */

    this.$ = yyvstack[yysp - 2]+yyvstack[yysp - 1]+yyvstack[yysp];
    break;

case 14:
    /*! Production::    start_caret : "^" */

    this.$ = '^';
    break;

case 15:
    /*! Production::    start_caret : %epsilon */
case 17:
    /*! Production::    end_dollar : %epsilon */

    this.$ = '';
    break;

case 16:
    /*! Production::    end_dollar : "$" */

    this.$ = '$';
    break;

case 18:
    /*! Production::    regex_list : regex_list "|" regex_chain */

    this.$ = yyvstack[yysp - 2]+'|'+yyvstack[yysp];
    break;

case 20:
    /*! Production::    regex_chain : regex_chain regex_base */
case 29:
...
case 21:
    /*! Production::    regex_chain : regex_base */
...
case 33:
    /*! Production::    name_expansion : "{" name "}" */
