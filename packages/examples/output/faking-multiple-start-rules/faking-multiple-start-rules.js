 ...
 */
            ...
            var fakingMultipleStartRules = (function () {
...
performAction: function parser__PerformAction(yystate /* action[1] */, yysp, yyvstack) {
          ...
          switch (yystate) {
case 0:
    /*! Production::    $accept : start_parsing $end */
...
case 1:
    /*! Production::    start_parsing : do_the_work */
...
case 2:
    /*! Production::    do_the_work : VALUE_PARSE_MODE value EOF */
...
case 3:
    /*! Production::    do_the_work : DATE_PARSE_MODE date EOF */
    ...
    return {
        date: yyvstack[yysp - 1]
    };
    break;

case 4:
    /*! Production::    do_the_work : TIME_PARSE_MODE time EOF */
...
case 15:
    /*! Production::    month : INTEGER */
case 16:
    /*! Production::    month : MONTH */
case 17:
    /*! Production::    day : INTEGER */
case 20:
    /*! Production::    hour : INTEGER */
case 21:
    /*! Production::    minute : INTEGER */
case 22:
    /*! Production::    second : INTEGER */
...
case 13:
    ...
    this.$ = yyvstack[yysp - 4] + '-' + yyvstack[yysp - 2] + '-' + yyvstack[yysp];
    break;
...
case 19:
    /*! Production::    time : hour ":" minute */

    this.$ = yyvstack[yysp - 2] + ':' + yyvstack[yysp] + ':00';
    break;
...
parse: function parse(input, mode) {
    var self = this;
    ...
    var NO_ACTION = [0, 46 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
    ...
    var sharedState_yy = {
        ...
        pre_lex: undefined,
        post_lex: undefined,
        mode: mode  // parseParams::mode      // WARNING: must be written this way for the code expanders to work correctly in both ES5 and ES6 modes!
    };
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 15:
        ...
        /*! Rule::       . */
        yy.lexer.parseError(
          'Don\'t know what to do with this: it\'s unsupported input: \'' + yy_.yytext + '\''
        );
    ...
    rules: [
      ...
      /*  3: */  /^(?:.)/,
      /*  4: */  /^(?:$)/,
      /*  5: */  /^(?:([^\u0000-@\[-`{-©«-´¶-¹»-¿×÷˂-˅˒-˟˥-˫˭˯-̈́͆-ͯ͵͸͹;΀-΅·΋΍΢϶҂-҉԰՗՘՚-ՠֈ-֯־׀׃׆׈-׏׫-ׯ׳-؏؛-؟٘٠-٭۔۝-۠۩-۬۰-۹۽۾܀-܏݀-݌޲-߉߫-߳߶-߹߻-߿࠘࠙࠭-࠿࡙-࢟ࢵࢾ-࣓࣠-࣢࣪-़्࣯॑-॔।-॰঄঍঎঑঒঩঱঳-঵঺-়৅৆৉৊্৏-৖৘-৛৞৤-৯৲-਀਄਋-਎਑਒਩਱਴਷਺-਽੃-੆੉੊੍-੐੒-੘੝੟-੯੶-઀઄઎઒઩઱઴઺-઼૆૊્-૏૑-૟૤-૸ૺ-଀଄଍଎଑଒଩଱଴଺-଼୅୆୉୊୍-୕୘-୛୞୤-୰୲-஁஄஋-஍஑஖-஘஛஝஠-஢஥-஧஫-஭஺-஽௃-௅௉்-௏௑-௖௘-௿ఄ఍఑఩఺-఼౅౉్-౔౗౛-౟౤-౿಄಍಑಩಴಺-಼೅೉್-೔೗-ೝ೟೤-೰ೳ-ഀഄ഍഑഻഼൅൉്൏-൓൘-൞൤-൹඀ඁ඄඗-඙඲඼඾඿෇-෎෕෗෠-෱෴-฀฻-฿็-์๎-຀຃຅ຆຉ຋ຌຎ-ຓຘຠ຤຦ຨຩຬ຺຾຿໅໇-໌໎-໛໠-໿༁-༿཈཭-཰ྂ-྇྘྽-࿿့္်၀-၏ၣၤၩ-ၭႇ-ႍႏ-ႛ႞႟჆჈-჌჎჏჻቉቎቏቗቙቞቟኉኎኏኱኶኷኿዁዆዇዗጑጖጗፛-፞፠-፿᎐-᎟᏶᏷᏾-᐀᙭᙮ ᚛-᚟᛫-᛭᛹-᛿ᜍ᜔-ᜟ᜴-᜿᝔-᝟᝭᝱᝴-᝿឴឵៉-៖៘-៛៝-᠟ᡸ-᡿᢫-᢯᣶-᣿᤟᤬-᤯᤹-᥏᥮᥯᥵-᥿᦬-᦯᧊-᧿᨜-᨟᩟᩠᩵-᪦᪨-᫿᬴᭄ᭌ-᭿᮪᮫᮰-᮹᯦᯲-᯿ᰶ-᱌᱐-᱙᱾᱿Ᲊ-᳨᳭᳴᳷-᳿᷀-ᷦ᷵-᷿἖἗἞἟὆὇὎὏὘὚὜὞὾὿᾵᾽᾿-῁῅῍-῏῔῕῜-῟῭-῱῵´-⁰⁲-⁾₀-₏₝-℁℃-℆℈℉℔№-℘℞-℣℥℧℩℮℺℻⅀-⅄⅊-⅍⅏-⅟↉-⒵⓪-⯿Ⱟⱟ⳥-⳪⳯-⳱⳴-⳿⴦⴨-⴬⴮⴯⵨-⵮⵰-⵿⶗-⶟⶧⶯⶷⶿⷇⷏⷗⷟⸀-⸮⸰-〄〈-〠〪-〰〶〷〽-぀゗-゜゠・㄀-㄄ㄮ-㄰㆏-㆟ㆻ-㇯㈀-㏿䶶-䷿鿖-鿿꒍-꓏꓾꓿꘍-꘏꘠-꘩꘬-꘿꙯-꙳꙼-꙾꛰-꜖꜠꜡꞉꞊ꞯꞸ-ꟶꠂ꠆ꠋ꠨-꠿꡴-꡿꣄꣆-꣱꣸-꣺꣼ꣾ-꤉꤫-꤯꥓-꥟꥽-꥿꦳꧀-꧎꧐-꧟ꧥ꧰-꧹꧿꨷-꨿꩎-꩟꩷-꩹ꩻ-ꩽ꪿꫁꫃-꫚꫞꫟꫰꫱꫶-꬀꬇꬈꬏꬐꬗-꬟꬧꬯꭛ꭦ-꭯꯫-꯿힤-힯퟇-퟊퟼-﩮﩯﫚-﫿﬇-﬒﬘-﬜﬩﬷﬽﬿﭂﭅﮲-﯒﴾-﵏﶐﶑﷈-﷯﷼-﹯﹵﻽-＠［-｀｛-･﾿-￁￈￉￐￑￘￙￝-\uffff])+)/,
      /*  6: */  /^(?:((?:\d+(?:\.\d*)?|\.\d+)))/,
    ...
    conditions: {
      ...
      'INITIAL': {
        rules: [5, 7, 8, 9, 10, 11, 12, 13, 14, 15],
        inclusive: true
      }
    }
  };
...
parser.pre_parse = function (yy, parser_mode) {
    /*
...
parser.main = function () {
    ...
    // very useful to quickly make the parse process produce a known result even when errors have
    // occurred: 
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = fakingMultipleStartRules;
  exports.Parser = fakingMultipleStartRules.Parser;
  exports.parse = function () {
    return fakingMultipleStartRules.parse.apply(fakingMultipleStartRules, arguments);
  };
