...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 6 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = basic_lex;
  exports.Parser = basic_lex.Parser;
  exports.parse = function () {
    return basic_lex.parse.apply(basic_lex, arguments);
  };
