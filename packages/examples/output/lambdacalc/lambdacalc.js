...
case 2:
    /*! Production::    expr : LAMBDA var_list "." expr */

    var temp = ["LambdaExpr", yyvstack[yysp - 2].shift(), yyvstack[yysp]];
    yyvstack[yysp - 2].forEach(function (v) {
...
case 3:
    /*! Production::    expr : expr SEP expr */

    this.$ = ["ApplyExpr", yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 4:
    /*! Production::    expr : var */

    this.$ = ["VarExpr", yyvstack[yysp]];
    break;
...
case 6:
    /*! Production::    var_list : var_list var */

    this.$ = yyvstack[yysp - 1]; this.$.unshift(yyvstack[yysp]);
    break;

case 7:
    /*! Production::    var_list : var */
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = lambdacalc;
  exports.Parser = lambdacalc.Parser;
  exports.parse = function () {
    return lambdacalc.parse.apply(lambdacalc, arguments);
  };
