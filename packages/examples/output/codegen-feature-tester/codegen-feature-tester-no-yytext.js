 ...
 */
            ...
            var codegenFeatureTesterNoYytext = (function () {
...
case 2:
    ...
    print('~~~EOF~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': typeof yyvstack[yysp - 1], '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 17;
...
case 5:
    ...
    print('~~~EXPR-OPERATOR~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': yyvstack[yysp - 2], '$2': typeof yyvstack[yysp - 1], '$3': yyvstack[yysp], '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = codegenFeatureTesterNoYytext;
  exports.Parser = codegenFeatureTesterNoYytext.Parser;
  exports.parse = function () {
    return codegenFeatureTesterNoYytext.parse.apply(codegenFeatureTesterNoYytext, arguments);
  };
