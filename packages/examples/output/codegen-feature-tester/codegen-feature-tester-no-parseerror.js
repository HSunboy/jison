 ...
 */
            ...
            var codegenFeatureTesterNoParseerror = (function () {
...
case 2:
    ...
    print('~~~EOF~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': typeof yyvstack[yysp - 1], yytext: yytext, '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr });
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 17;
...
case 5:
    ...
    print('~~~EXPR-OPERATOR~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': yyvstack[yysp - 2], '$2': typeof yyvstack[yysp - 1], '$3': yyvstack[yysp], yytext: yytext, '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr });
    yyparser.yyErrOk();
    yyparser.yyClearIn();
...
case 23:
    ...
    print('~~~V~~~', parser.describeSymbol( /* undefined */ 0), ' error: ', { '$1': typeof yyvstack[yysp], '@$': this._$, token: parser.describeSymbol( /* undefined */ 0), msg: yyvstack[yysp].errStr }, yysp);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 5;         
    // ^-- every error recovery rule in this grammar adds a different value 
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = codegenFeatureTesterNoParseerror;
  exports.Parser = codegenFeatureTesterNoParseerror.Parser;
  exports.parse = function () {
    return codegenFeatureTesterNoParseerror.parse.apply(codegenFeatureTesterNoParseerror, arguments);
  };
