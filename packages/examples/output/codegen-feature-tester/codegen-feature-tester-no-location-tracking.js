 ...
 */
            ...
            var codegenFeatureTesterNoLocationTracking = (function () {
...
case 2:
    ...
    print('~~~EOF~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': typeof yyvstack[yysp - 1], yytext: yytext, token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 17;
...
case 5:
    ...
    print('~~~EXPR-OPERATOR~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': yyvstack[yysp - 2], '$2': typeof yyvstack[yysp - 1], '$3': yyvstack[yysp], yytext: yytext, token: parser.describeSymbol( /* error */ 2), msg: yyvstack[yysp - 1].errStr }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
...
case 23:
    ...
    print('~~~V~~~', parser.describeSymbol( /* undefined */ 0), ' error: ', { '$1': typeof yyvstack[yysp], token: parser.describeSymbol( /* undefined */ 0), msg: yyvstack[yysp].errStr }, yy.lastErrorMessage, yy.lastErrorHash.token, yysp);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 5;         
    // ^-- every error recovery rule in this grammar adds a different value 
        ...
        for (;;) {
            ...
            if (this.defaultActions[state]) {
                ...
                if (!action) {
                    ...
                    r = this.performAction.call(yyval, yytext, NO_ACTION[1], sp - 1, vstack);
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = codegenFeatureTesterNoLocationTracking;
  exports.Parser = codegenFeatureTesterNoLocationTracking.Parser;
  exports.parse = function () {
    return codegenFeatureTesterNoLocationTracking.parse.apply(codegenFeatureTesterNoLocationTracking, arguments);
  };
