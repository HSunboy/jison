...
case 23:
    ...
    print('~~~V~~~', parser.describeSymbol( /* undefined */ 0), ' error: ', { '$1': typeof yyvstack[yysp], '@$': this._$, token: parser.describeSymbol( /* undefined */ 0), msg: yyvstack[yysp].errStr }, yy.lastErrorMessage, yy.lastErrorHash.token);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = 5;         
    // ^-- every error recovery rule in this grammar adds a different value 
