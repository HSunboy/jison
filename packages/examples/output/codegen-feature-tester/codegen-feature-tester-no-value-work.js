 ...
 */
            ...
            var codegenFeatureTesterNoValueWork = (function () {
...
case 2:
    ...
    print('~~~EOF~~~', parser.describeSymbol( /* error */ 2), ' error: ', { yytext: yytext, '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2) }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    break;
...
case 5:
    ...
    print('~~~EXPR-OPERATOR~~~', parser.describeSymbol( /* error */ 2), ' error: ', { yytext: yytext, '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2) }, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    break;
...
case 23:
    ...
    // default action (generated by JISON mode none/none :: 1,VT,VA,-,-,LT,LA,LU,LUbA):
    this.$ = undefined;
    this._$ = undefined;
    // END of default action (generated by JISON mode none/none :: 1,VT,VA,-,-,LT,LA,LU,LUbA)
    
    
    print('~~~V~~~', parser.describeSymbol( /* undefined */ 0), ' error: ', { '@$': this._$, token: parser.describeSymbol( /* undefined */ 0) }, yy.lastErrorMessage, yy.lastErrorHash.token, yysp);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    break;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = codegenFeatureTesterNoValueWork;
  exports.Parser = codegenFeatureTesterNoValueWork.Parser;
  exports.parse = function () {
    return codegenFeatureTesterNoValueWork.parse.apply(codegenFeatureTesterNoValueWork, arguments);
  };
