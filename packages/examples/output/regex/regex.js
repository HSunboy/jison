...
case 1:
    ...
    yyparser.yyError("empty");
    break;

case 2:
    /*! Production::    prog : expr1 EOF */
...
case 4:
    ...
    this.$ = re.union(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 6:
    /*! Production::    expr2 : expr2 expr3 */

    this.$ = re.cat(yyvstack[yysp - 1], yyvstack[yysp]);
    break;

case 8:
    /*! Production::    expr3 : expr3 "*" */

    this.$ = re.star(yyvstack[yysp - 1]);
    break;

case 9:
    /*! Production::    expr3 : expr3 "+" */

    this.$ = re.plus(yyvstack[yysp - 1]);
    break;

case 10:
    /*! Production::    expr3 : expr3 "?" */

    this.$ = re.question(yyvstack[yysp - 1]);
    break;

case 11:
    /*! Production::    expr4 : TERMINAL */

    this.$ = re.terminal(yyvstack[yysp]);
    break;

case 12:
    /*! Production::    expr4 : "(" expr1 ")" */
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = regex;
  exports.Parser = regex.Parser;
  exports.parse = function () {
    return regex.parse.apply(regex, arguments);
  };
