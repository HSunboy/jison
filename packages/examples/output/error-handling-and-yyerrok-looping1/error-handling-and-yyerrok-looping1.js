 ...
 */
            ...
            var errorHandlingAndYyerrokLooping1 = (function () {
...
performAction: function parser__PerformAction(yystate /* action[1] */) {
...
case 1:
    /*! Production::    slist : slist stmt ";" */

    console.log("** slist stmt");
    break;

case 2:
    /*! Production::    slist : stmt ";" */

    console.log("** stmt");
    break;

case 4:
    /*! Production::    stmt : error */

    if (!yy.error_count) { yy.error_count = 1; } else { yy.error_count++; }
    
    console.log("** yyerrok #" + yy.error_count);
    yyparser.yyErrOk();            // <-- abort error process when error found
    
    if (yy.error_count > 42) { throw new Error('kaboom! loop!'); }
    break;

case 8:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 8 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
        ...
        for (;;) {
            ...
            if (this.defaultActions[state]) {
                ...
                if (!action) {
                    ...
                    r = this.performAction.call(yyval, NO_ACTION[1]);
                    ...
                    for (;;) {
                        ...
                        case 2:
                            ...
                            r = this.performAction.call(yyval, newState);
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = errorHandlingAndYyerrokLooping1;
  exports.Parser = errorHandlingAndYyerrokLooping1.Parser;
  exports.parse = function () {
    return errorHandlingAndYyerrokLooping1.parse.apply(errorHandlingAndYyerrokLooping1, arguments);
  };
