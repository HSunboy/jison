...
case 1:
    /*! Production::    expressions : expression EOF */
...
case 2:
    /*! Production::    expression : variableSequence */

    //js
    this.$ = yy.handler.variable.apply(yy.obj, yyvstack[yysp]);
...
case 3:
    /*! Production::    expression : TIME_AMPM */

    //js
    this.$ = yy.handler.time.apply(yy.obj, [yyvstack[yysp], true]);
    //
    break;

case 4:
    /*! Production::    expression : TIME_24 */

    //js
    this.$ = yy.handler.time.apply(yy.obj, [yyvstack[yysp]]);
    //
    break;
...
case 5:
    ...
    //js
    this.$ = yy.handler.number.apply(yy.obj, [yyvstack[yysp]]);
...
case 7:
    ...
    //js
    yy.obj.html.pop();
    this.$ = yy.handler.callFunction.apply(yy.obj, ['EQUAL', [yyvstack[yysp - 2], yyvstack[yysp]]]);
...
case 8:
    ...
    //js
    this.$ = yy.handler.performMath.apply(yy.obj, ['+', yyvstack[yysp - 2], yyvstack[yysp]]);
    yy.obj.html.pop();
    yy.obj.html.pop();
...
case 9:
    ...
    //js
    this.$ = yy.handler.number.apply(yy.obj, [yyvstack[yysp - 1]]);
    //
    break;
...
case 10:
    ...
    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, ['LESS_EQUAL', [yyvstack[yysp - 3], yyvstack[yysp - 1]]]);
...
case 11:
    ...
    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, ['GREATER_EQUAL', [yyvstack[yysp - 3], yyvstack[yysp - 1]]]);
...
case 12:
    ...
    //js|php
    this.$ = (yyvstack[yysp - 3] * 1) != (yyvstack[yysp] * 1);
...
case 13:
    /*! Production::    expression : expression NOT expression */
...
case 14:
    ...
    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, ['GREATER', [yyvstack[yysp - 2], yyvstack[yysp]]]);
...
case 15:
    ...
    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, ['LESS', [yyvstack[yysp - 2], yyvstack[yysp]]]);
...
case 16:
    ...
    //js|php
    this.$ = (yyvstack[yysp - 2] * 1) - (yyvstack[yysp] * 1);
...
case 19:
    ...
    //js
    var n1 = yy.handler.number.apply(yy.obj, [yyvstack[yysp - 2]]),
        n2 = yy.handler.number.apply(yy.obj, [yyvstack[yysp]]);
...
case 20:
    ...
    //js
    var n1 = yy.handler.number.apply(yy.obj, [yyvstack[yysp]]);
    this.$ = n1 * -1;
    if (isNaN(this.$)) this.$ = 0;
...
case 23:
    /*! Production::    expression : FUNCTION "(" ")" */

    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, [yyvstack[yysp - 2], '']);
...
case 24:
    /*! Production::    expression : FUNCTION "(" expseq ")" */

    //js
    this.$ = yy.handler.callFunction.apply(yy.obj, [yyvstack[yysp - 3], yyvstack[yysp - 1]]);
...
case 27:
    /*! Production::    expression : error error */
...
case 28:
    ...
    //js
    this.$ = yy.handler.fixedCellValue.apply(yy.obj, [yyvstack[yysp]]);
...
case 29:
    ...
    //js
    this.$ = yy.handler.fixedCellRangeValue.apply(yy.obj, [yyvstack[yysp - 2], yyvstack[yysp]]);
...
case 30:
    ...
    //js
    this.$ = yy.handler.cellValue.apply(yy.obj, [yyvstack[yysp]]);
...
case 31:
    ...
    //js
    this.$ = yy.handler.cellRangeValue.apply(yy.obj, [yyvstack[yysp - 2], yyvstack[yysp]]);
...
case 32:
    ...
    //js
    this.$ = yy.handler.remoteCellValue.apply(yy.obj, [yyvstack[yysp - 2], yyvstack[yysp]]);
...
case 33:
    ...
    //js
    this.$ = yy.handler.remoteCellRangeValue.apply(yy.obj, [yyvstack[yysp - 4], yyvstack[yysp - 2], yyvstack[yysp]]);
...
case 35:
    /*! Production::    expseq : expseq ";" expression */
case 36:
    /*! Production::    expseq : expseq "," expression */
...
case 41:
    ...
    //js
    yy.obj.html.push(yyvstack[yysp - 1] + yyvstack[yysp]);
...
case 79:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 79 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
EOF: 1,
    ...
    simpleCaseActionClusters: {
      ...
      /*! Conditions:: INITIAL */
      /*! Rule::       ([0]?[0-9]|1[0-9]|2[0-3])[:][0-5][0-9]([:][0-5][0-9])? */
      5: 21,
    ...
    rules: [
      ...
      /*  2: */  /^(?:'(\\[']|[^'])*')/,
      /*  3: */  /^(?:[A-Za-z]{1,}\w+(?=[(]))/,
      /*  4: */  /^(?:([0]?[1-9]|1[0-2])[:][0-5]\d([:][0-5]\d)?[ ]?(AM|am|aM|Am|PM|pm|pM|Pm))/,
      /*  5: */  /^(?:([0]?\d|1\d|2[0-3])[:][0-5]\d([:][0-5]\d)?)/,
      /*  6: */  /^(?:SHEET\d+)/,
      /*  7: */  /^(?:\$[A-Za-z]+\$\d+)/,
      /*  8: */  /^(?:[A-Za-z]+\d+)/,
      /*  9: */  /^(?:[A-Za-z]+(?=[(]))/,
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  ...
  exports.parse = function () {
    return formula.parse.apply(formula, arguments);
  };
