...
case 1:
    ...
    // default action (generated by JISON mode none/none :: 4,VT,VA,-,-,-,-,-,-):
    this.$ = undefined;
    // END of default action (generated by JISON mode none/none :: 4,VT,VA,-,-,-,-,-,-)
    
    
    parser.trace('S:complete = ', yyvstack[yysp]);
    break;

case 2:
    /*! Production::    init : %epsilon */

    // default action (generated by JISON mode none/none :: 0,VT,VA,-,-,-,-,-,-):
    this.$ = undefined;
    // END of default action (generated by JISON mode none/none :: 0,VT,VA,-,-,-,-,-,-)
    
    
    parser.trace('init:epsilon');
    break;

case 3:
    /*! Production::    x : %epsilon */

    parser.trace('X:epsilon');                    this.$ = '<X-epsilon>';
    break;

case 4:
    /*! Production::    e : cmd e */

    parser.trace('e:cmd=', yyvstack[yysp - 1]);                 this.$ = yyvstack[yysp - 1] + ' | ' + yyvstack[yysp];
    break;

case 5:
    /*! Production::    e : %epsilon */

    parser.trace('e:epsilon');                    this.$ = '<E-epsilon>';
    break;

case 6:
    /*! Production::    cmd : a */

    parser.trace('cmd:a');                        this.$ = yyvstack[yysp];
    break;

case 7:
    /*! Production::    cmd : f_a */

    parser.trace('cmd:function a()');             this.$ = yyvstack[yysp];
    break;

case 8:
    /*! Production::    cmd : b */

    parser.trace('cmd:b');                        this.$ = yyvstack[yysp];
    break;

case 9:
    /*! Production::    cmd : f_b */

    parser.trace('cmd:function b()');             this.$ = yyvstack[yysp];
    break;

case 10:
    /*! Production::    cmd : error */

    parser.trace('cmd:error', get_reduced_error_info_obj(yyvstack[yysp]) || yyvstack[yysp]);            yyparser.yyErrOk(); yyparser.yyClearIn(); this.$ = 'ERROR';
    break;

case 11:
    /*! Production::    a : A */

    parser.trace('a:A');                          this.$ = 'A[' + yyvstack[yysp] + ']';
    break;

case 12:
    /*! Production::    f_a : A lb e rb */

    parser.trace('function a:', yyvstack[yysp - 1]);              this.$ = 'A' + yyvstack[yysp - 2] + yyvstack[yysp - 1] + yyvstack[yysp];
    break;

case 13:
    /*! Production::    b : B */

    parser.trace('b:B');                          this.$ = 'B[' + yyvstack[yysp] + ']';
    break;

case 14:
    /*! Production::    f_b : B lb e rb */

    parser.trace('function b:', yyvstack[yysp - 1]);              this.$ = 'B' + yyvstack[yysp - 2] + yyvstack[yysp - 1] + yyvstack[yysp];
    break;

case 15:
    /*! Production::    lb : "(" */

    parser.trace('lb+PUSH:[(] ');                 yy.lexer.pushState('alt'); this.$ = '(';
    break;

case 16:
    /*! Production::    lb : BEGIN */

    parser.trace('lb:[alt-(] ');                  this.$ = '{';
    break;

case 17:
    /*! Production::    rb : ")" */

    parser.trace('lb:[)] ');                      this.$ = ')';
    break;

case 18:
    /*! Production::    rb : END */

    parser.trace('lb+POP:[alt-)] ');              yy.lexer.popState(); this.$ = '}';
    break;
