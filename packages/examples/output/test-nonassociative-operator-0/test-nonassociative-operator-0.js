 ...
 */
            ...
            var testNonassociativeOperator_0 = (function () {
...
case 3:
    ...
    this.$ = parser.pop_all_markers() + yyvstack[yysp - 2] + ' ERR2: ' + yyvstack[yysp - 1].value + ' CONT: ' + yyvstack[yysp];
    break;

case 4:
    /*! Production::    e : error */

    this.$ = parser.pop_all_markers() + ' ERR1: ' + yyvstack[yysp].value;
    break;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = testNonassociativeOperator_0;
  exports.Parser = testNonassociativeOperator_0.Parser;
  exports.parse = function () {
    return testNonassociativeOperator_0.parse.apply(testNonassociativeOperator_0, arguments);
  };
