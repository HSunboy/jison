 ...
 */
            ...
            var errorHandlingAndYyerrokPart3 = (function () {
...
case 12:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 12 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = errorHandlingAndYyerrokPart3;
  exports.Parser = errorHandlingAndYyerrokPart3.Parser;
  exports.parse = function () {
    return errorHandlingAndYyerrokPart3.parse.apply(errorHandlingAndYyerrokPart3, arguments);
  };
