...
case 2:
    ...
    print('~~~', parser.describeSymbol( /* error */ 2), ' error: ', { '$1': yyvstack[yysp - 2], '$2': typeof yyvstack[yysp - 1], yytext: yytext, '@error': yylstack[yysp - 1], token: parser.describeSymbol( /* error */ 2)}, yy.lastErrorMessage);
    yyparser.yyErrOk();
    yyparser.yyClearIn();
    this.$ = yyvstack[yysp - 2] + 3;
...
case 22:
    ...
    //print('~~~ (...) error: ', { '$1': $1, '#1': #1, yytext: yytext, '$$': $$, '@$': @$, token: parser.describeSymbol(#$), 'yystack': yystack, 'yyvstack': yyvstack, 'yylstack': yylstack, last_error: yy.lastErrorMessage});
    print('~~~', parser.describeSymbol( /* undefined */ 0), ' error: ', { '$1': typeof yyvstack[yysp], yytext: yytext, '@$': this._$, token: parser.describeSymbol( /* undefined */ 0), 'yyvstack': yyvstack }, yy.lastErrorMessage, yy.lastErrorHash.token, yysp);
    yyparser.yyErrOk();
    //yyclearin;
    this.$ = 5;         
    // ^-- every error recovery rule in this grammar adds a different value 
...
case 37:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 37 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = noPrecHackNeeded;
  exports.Parser = noPrecHackNeeded.Parser;
  exports.parse = function () {
    return noPrecHackNeeded.parse.apply(noPrecHackNeeded, arguments);
  };
