    ...
    | regex ARROW_ACTION_START action_block ACTION_END
        {
            ...
            let rv = checkActionBlock(srcCode, @action_block, yy.options);
            if (rv.fault) {
