(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['lex-parser'] = factory(global.XRegExp, global.JSON5, global.fs, global.path, global.recast, global.assert, global.yaml));
            ...
            case 'names':
                ...
                for (let i = 0, len = condition_defs.length; i < len; i++) {
                    ...
                    if (name in this.$.startConditions && this.$.startConditions[name] !== condition_defs[i][1]) {
                        yyparser.yyError(rmCommonWS$1`
                        You have specified the lexer condition state ${dquote$1(name)} as both
    ...
    case 9:
        ...
        if (XRegExp__default['default']._getUnicodeProperty(yyvstack[yysp - 2])) {
            ...
            if (yyvstack[yysp - 2].toUpperCase() !== yyvstack[yysp - 2]) {
                yyparser.yyError(rmCommonWS$1`
              Cannot use name ${dquote$1(yyvstack[yysp - 2])} as a macro name
              as it clashes with the same XRegExp "\\p{..}" Unicode \'General Category\'
              Property name.
              Use all-uppercase macro names, e.g. name your macro
              ${dquote$1(yyvstack[yysp - 2].toUpperCase())} to work around this issue
    ...
    case 20:
        ...
        yyparser.yyError(rmCommonWS$1`
        ill defined ${dquote$1(yyvstack[yysp - 2])} line.
    ...
    case 29:
        ...
        ${dquote$1(yy.__options_category_description__)} definition statement, so please do check above
    ...
    case 78:
        ...
        this.$ = yyvstack[yysp - 2].map(function (el) {
            ...
            if (name !== '*' && name !== 'INITIAL' && !(name in yy.startConditions)) {
                yyparser.yyError(rmCommonWS$1`
                You specified an unknown lexer condition state ${dquote$1(name)}.
    ...
    case 127:
        ...
        if (yy.__options_flags__ & OPTION_DOES_NOT_ACCEPT_VALUE) {
            yyparser.yyError(rmCommonWS$1`
            The entries in a ${yy.__options_category_description__} statement MUST NOT be assigned values, such as ${dquote$1(yyvstack[yysp - 2] + '=' + yyvstack[yysp])}.
    ...
    case 128:
        ...
        // TODO ...
        yyparser.yyError(rmCommonWS$1`
        Internal error: option ${dquote$1($option)} value assignment failure in a ${yy.__options_category_description__} statement.
    ...
    case 145:
        ...
        if (!fs__default['default'].existsSync(include_path)) {
            yyparser.yyError(rmCommonWS$1`
            Cannot %include ${dquote$1(include_path)}:
        ...
        `);
            ...
            if (srcCode) {
                ...
                if (rv.fault) {
                    yyparser.yyError(rmCommonWS$1`
                    The source code included from file ${dquote$1(include_path)} does not compile: ${rv.fault}
