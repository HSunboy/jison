(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@gerhobbelt/xregexp'), require('jison-helpers-lib'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['@gerhobbelt/xregexp', 'jison-helpers-lib', 'fs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["lex-parser"] = factory(global.XRegExp, global.helpers, global.fs));
})(this, (function (XRegExp, helpers, fs) { 'use strict';
