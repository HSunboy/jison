...
case 9:
    ...
    if (XRegExp._getUnicodeProperty(yyvstack[yysp - 2])) {
        ...
        if (yyvstack[yysp - 2].toUpperCase() !== yyvstack[yysp - 2]) {
            yyparser.yyError(rmCommonWS`
              Cannot use name ${dquote(yyvstack[yysp - 2])} as a macro name
              as it clashes with the same XRegExp "\\p{..}" Unicode \'General Category\'
              Property name.
              Use all-uppercase macro names, e.g. name your macro
              ${dquote(yyvstack[yysp - 2].toUpperCase())} to work around this issue
...
case 20:
    ...
    yyparser.yyError(rmCommonWS`
        ill defined ${dquote(yyvstack[yysp - 2])} line.
...
case 127:
    ...
    if (yy.__options_flags__ & OPTION_DOES_NOT_ACCEPT_VALUE) {
        yyparser.yyError(rmCommonWS`
            The entries in a ${yy.__options_category_description__} statement MUST NOT be assigned values, such as ${dquote(yyvstack[yysp - 2] + '=' + yyvstack[yysp])}.
