...
case 16:
    ...
    {
    let srcCode = trimActionCode(yyvstack[yysp - 1], yyvstack[yysp - 2]);
    if (srcCode) {
...
case 25:
    ...
    let srcCode = trimActionCode(yyvstack[yysp - 2], yyvstack[yysp - 3]);
...
case 189:       // === NO_ACTION[1] :: ensures that anyone (but us) using this new state will fail dramatically!
