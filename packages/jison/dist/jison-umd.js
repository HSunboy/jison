(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jison-helpers-lib'), require('assert'), require('@gerhobbelt/jison-lex'), require('@gerhobbelt/ebnf-parser'), require('@gerhobbelt/lex-parser'), require('@gerhobbelt/json5'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/recast'), require('@gerhobbelt/ast-util'), require('path'), require('fs')) :
    typeof define === 'function' && define.amd ? define(['jison-helpers-lib', 'assert', '@gerhobbelt/jison-lex', '@gerhobbelt/ebnf-parser', '@gerhobbelt/lex-parser', '@gerhobbelt/json5', '@gerhobbelt/xregexp', '@gerhobbelt/recast', '@gerhobbelt/ast-util', 'path', 'fs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.jison = factory(global.helpers, global.assert, global.Lexer, global.ebnfParser, global.lexParser, global.json5, global.XRegExp, global.recast, global.astUtils, global.path, global.fs));
})(this, (function (helpers, assert, Lexer, ebnfParser, lexParser, json5, XRegExp, recast, astUtils, path, fs) { 'use strict';
