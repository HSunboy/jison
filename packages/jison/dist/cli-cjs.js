...
`;chkBugger(parseErrorSourceCode),parser.parseError=lrGeneratorMixin.parseError=eval(parseErrorSourceCode+"\n\nparseError;"),generatorMixin.createLexer=function(e,t,r,o){return new Lexer(e,t,r,o)};const define_parser_APIs_1=`
    TERROR: 2,
    EOF: 1,
