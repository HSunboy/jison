...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jison-helpers-lib'), require('assert'), require('@gerhobbelt/jison-lex'), require('@gerhobbelt/ebnf-parser'), require('@gerhobbelt/lex-parser'), require('@gerhobbelt/json5'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/recast'), require('@gerhobbelt/ast-util'), require('path'), require('fs'), require('process'), require('@gerhobbelt/nomnom')) : typeof define === 'function' && define.amd ? define(['jison-helpers-lib', 'assert', '@gerhobbelt/jison-lex', '@gerhobbelt/ebnf-parser', '@gerhobbelt/lex-parser', '@gerhobbelt/json5', '@gerhobbelt/xregexp', '@gerhobbelt/recast', '@gerhobbelt/ast-util', 'path', 'fs', 'process', '@gerhobbelt/nomnom'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["jison-cli"] = factory(global.helpers, global.assert, global.Lexer, global.ebnfParser, global.lexParser, global.json5, global.XRegExp, global.recast, global.astUtils, global.path, global.fs, global.process, global.nomnom));
})(undefined, function (helpers, assert, Lexer, ebnfParser, lexParser, json5, XRegExp, recast, astUtils, path, fs, process, nomnom) {
    'use strict';
    ...
    function grammarPrinter(raw, options) {
        ...
        if (raw.lex) {
            ...
            if (src && !isEmptyObj(src)) {
                lex_pre.push(rmCommonWS$2(_templateObject));
                ...
                lex_pre.push(rmCommonWS$2(_templateObject2));
            }

            src = raw.lex.unknownDecls;
            delete raw.lex.unknownDecls;
            if (src && !isEmptyObj(src)) {
                lex_pre.push(rmCommonWS$2(_templateObject3));
                ...
                lex_pre.push(rmCommonWS$2(_templateObject4));
            }

            src = raw.lex.options;
            delete raw.lex.options;
            if (src && !isEmptyObj(src)) {
                lex_pre.push(rmCommonWS$2(_templateObject5));
            ...
            if (!isEmptyObj(raw.lex)) {
                ...
                out += rmCommonWS$2(_templateObject6, rem.replace(/\*\//g, '*\\/'));
            }
            delete raw.lex;

            out += lex_pre.join('\n') + '\n\n';
            out += rmCommonWS$2(_templateObject7) + lex_rules.join('\n') + '\n\n';
            if (lex_post.length > 0) {
                out += rmCommonWS$2(_templateObject8) + lex_post.join('\n') + '\n\n';
            }
            lex_out_str = out;
        }
        ...
        if (src && !isEmptyObj(src)) {
            lex_pre.push(rmCommonWS$2(_templateObject9));
            ...
            lex_pre.push(rmCommonWS$2(_templateObject10));
        }
        ...
        if (lex_out_str.trim() && options.showLexer) {
            grammar_pre.push(rmCommonWS$2(_templateObject11, lex_out_str));
        }
        ...
        if (!isEmptyObj(raw)) {
            ...
            out += rmCommonWS$2(_templateObject12, rem.replace(/\*\//g, '*\\/'));
            // delete raw;
        }
        ...
        if (!options.showParser) {
            ...
            out += rmCommonWS$2(_templateObject7);
            ...
            if (ebnf_rules.length > 0) {
                if (bnf_rules.length > 0) {
                    ...
                    out += rmCommonWS$2(_templateObject13, a.join('\n'));
                }
                out += ebnf_rules.join('\n\n') + '\n\n';
            ...
            if (grammar_post.length > 0) {
                out += rmCommonWS$2(_templateObject8) + grammar_post.join('\n') + '\n\n';
            }
        }
        ...
        if (options.format === 'json5') {
            ...
            out = rmCommonWS$2(_templateObject14, options.showParser ? 'grammar' : 'lexer', a.join('\n'));
        ...
        moduleInit.getRemainingInitCodeSections = function getRemainingInitCodeSections() {
            ...
            for (var i = 0, len = this.length; i < len; i++) {
                ...
                if (!this.__consumedInitCodeSlots__[i]) {
                    rv.push(rmCommonWS$1(_templateObject15, m.qualifier, m.include, m.qualifier));
                    this.__consumedInitCodeSlots__[i] = true;
                }
            }
            return rv;
    ...
    lrGeneratorMixin.generateESModule = function generateESModule(opt) {
        ...
        if (!opt.noMain) {
            ...
            out.push(rmCommonWS$1(_templateObject16, moduleImportsAsCode, moduleNameAsCode.trim()));
            exportMain = 'main: yyExecMain,';
            invokeMain = rmCommonWS$1(_templateObject17);
        }
        out.push(rmCommonWS$1(_templateObject18, invokeMain, exportMain));
    ...
    generatorMixin.generateCommonJSModule = function generateCommonJSModule(opt) {
        ...
        if (!opt.noMain) {
            ...
            main = rmCommonWS$1(_templateObject19, moduleImportsAsCode, moduleNameAsCode.trim());
        }
        var out = this.generateModule(opt) + rmCommonWS$1(_templateObject20, moduleName, moduleName, moduleName, moduleName, main);
    ...
    generatorMixin.createParser = function createParser() {
        ...
        var sourcecode = rmCommonWS$1(_templateObject21, sourceCodeDef.init, sourceCodeDef.src);
    ...
    function getCommandlineOptions() {
        ...
        var opts = nomnom.script('jison').unknownOptionTreatment(false) // do not accept unknown options!
        .produceExplicitOptionsOnly(true).options({
            file: {
                flag: true,
                position: 0,
            ...
            defaultActionMode: {
                ...
                help: rmCommonWS(_templateObject22)
            },
            hasTryCatch: {
                full: 'try-catch',
                flag: true,
            ...
            errorRecoveryTokenDiscardCount: {
                ...
                callback: function callback(count) {
