...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('recast'), require('assert'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', 'recast', 'assert', '@gerhobbelt/xregexp', '@gerhobbelt/json5'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fs, global.path, global.nomnom, global.recast, global.assert$1, global.XRegExp, global.json5));
}(this, (function (fs, path, nomnom, recast, assert$1, XRegExp, json5) { 'use strict';
