...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('jison-helpers-lib'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', 'jison-helpers-lib', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fs, global.path, global.nomnom, global.helpers, global.XRegExp, global.json5, global.lexParser, global.assert));
})(this, (function (fs, path, nomnom, helpers, XRegExp, json5, lexParser, assert) { 'use strict';
