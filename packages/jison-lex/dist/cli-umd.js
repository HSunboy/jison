...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('@gerhobbelt/json5'), require('mkdirp'), require('@gerhobbelt/xregexp'), require('recast'), require('@babel/core'), require('assert')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', '@gerhobbelt/json5', 'mkdirp', '@gerhobbelt/xregexp', 'recast', '@babel/core', 'assert'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['jison-lex'] = factory(global.fs, global.path$1, global.nomnom, global.JSON5, global.mkdirp, global.XRegExp, global.recast, global.babel, global.assert$1));
}(this, (function (fs, path$1, nomnom, JSON5, mkdirp, XRegExp, recast, babel, assert$1) { 'use strict';
