...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('process'), require('@gerhobbelt/nomnom'), require('assert'), require('@gerhobbelt/json5'), require('@gerhobbelt/xregexp'), require('recast'), require('@gerhobbelt/js-yaml')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', 'process', '@gerhobbelt/nomnom', 'assert', '@gerhobbelt/json5', '@gerhobbelt/xregexp', 'recast', '@gerhobbelt/js-yaml'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['jison-lex'] = factory(global.fs, global.path, global.process, global.nomnom, global.assert, global.JSON5, global.XRegExp, global.recast, global.yaml));
}(this, (function (fs, path, process$1, nomnom, assert$1, JSON5$1, XRegExp, recast, yaml) { 'use strict';
    ...
    symbols_: {
      ...
      "DUMMY": 19,
      "ENTIRE_ACTION": 37,
      "ENTIRE_ACTION_AT_SOL": 36,
      "EOF": 1,
      "ESCAPED_CHAR": 46,
      "IMPORT": 28,
      "INCLUDE": 30,
      "INCLUDE_PLACEMENT_ERROR": 39,
      "INIT_CODE": 29,
      "INTEGER": 57,
      "MACRO_END": 21,
      "MACRO_NAME": 20,
      ...
      "UNTERMINATED_REGEX_SET": 50,
      "UNTERMINATED_STRING_ERROR": 42,
      "^": 16,
      "action": 80,
      "action_block": 79,
      "action_chunk": 78,
      "action_chunk_at_SOL": 77,
      "any_group_regex": 88,
      "any_group_regex_option": 102,
      "any_option_value": 97,
      "definition": 63,
      "definitions": 62,
      "epilogue": 98,
      ...
      "import_keyword": 65,
      "include_keyword": 67,
      "include_macro_code": 101,
      "init": 61,
      "init_code_keyword": 66,
      "lex": 59,
      "literal_string": 92,
      "name_expansion": 87,
      "nonempty_regex_list": 84,
      "nonnumeric_option_value": 96,
      "option": 94,
      "option_keyword": 64,
      "option_list": 93,
      "option_name": 95,
      ...
      "rule_block": 75,
      "rules": 73,
      "rules_and_epilogue": 60,
      "scoped_rules_collective": 74,
      "start_conditions": 81,
      "start_conditions_marker": 70,
      "start_epilogue_marker": 72,
      "start_exclusive_keyword": 69,
      "start_inclusive_keyword": 68,
      "start_productions_marker": 71,
      "{": 4,
      "|": 7,
      "}": 5
    },
    terminals_: {
      ...
      35: "ACTION_END",
      36: "ENTIRE_ACTION_AT_SOL",
      37: "ENTIRE_ACTION",
      38: "ACTION_BODY",
      39: "INCLUDE_PLACEMENT_ERROR",
      40: "BRACKET_MISSING",
      41: "BRACKET_SURPLUS",
      42: "UNTERMINATED_STRING_ERROR",
      43: "SPECIAL_GROUP",
      44: "/!",
      45: "REGEX_SPECIAL_CHAR",
      46: "ESCAPED_CHAR",
      47: "NAME_BRACE",
      48: "REGEX_SET_START",
      49: "REGEX_SET_END",
      50: "UNTERMINATED_REGEX_SET",
      51: "REGEX_SET",
      52: "RANGE_REGEX",
      53: "STRING_LIT",
      54: "CHARACTER_LIT",
            ...
            case 'names':
                ...
                for (let i = 0, len = condition_defs.length; i < len; i++) {
                    ...
                    if (name in this.$.startConditions && this.$.startConditions[name] !== condition_defs[i][1]) {
                        yyparser.yyError(rmCommonWS$1`
                        You have specified the lexer condition state ${dquote$2(name)} as both
    ...
    case 9:
        ...
        if (XRegExp__default['default']._getUnicodeProperty(yyvstack[yysp - 2])) {
            ...
            if (yyvstack[yysp - 2].toUpperCase() !== yyvstack[yysp - 2]) {
                yyparser.yyError(rmCommonWS$1`
              Cannot use name ${dquote$2(yyvstack[yysp - 2])} as a macro name
              as it clashes with the same XRegExp "\\p{..}" Unicode \'General Category\'
              Property name.
              Use all-uppercase macro names, e.g. name your macro
              ${dquote$2(yyvstack[yysp - 2].toUpperCase())} to work around this issue
    ...
    case 15:
        /*! Production::    definition : action_chunk_at_SOL */
    ...
    case 20:
        ...
        yyparser.yyError(rmCommonWS$1`
        ill defined ${dquote$2(yyvstack[yysp - 2])} line.
    ...
    case 25:
        /*! Production::    definition : init_code_keyword option_list action_chunk OPTIONS_END */
    ...
    case 29:
        ...
        ${dquote$2(yy.__options_category_description__)} definition statement, so please do check above
    ...
    case 42:
        ...
        if (yyvstack[yysp - 1]) {
            yyvstack[yysp].start_condition = yyvstack[yysp - 1];
        }
    ...
    case 43:
        ...
        if (yyvstack[yysp - 3]) {
            yyvstack[yysp - 1].forEach(function (d) {
                d.start_condition = yyvstack[yysp - 3];
            });
        }
    ...
    case 49:
        /*! Production::    rule : regex action_chunk */
    case 50:
        /*! Production::    rule : regex action_chunk_at_SOL */
        ...
        rv.rule = yyvstack[yysp - 1];
        this.$ = rv;
        }
        break;

    case 51:
        /*! Production::    rule : regex ARROW_ACTION_START action_block ACTION_END */
        ...
        let ast = checkActionBlock$1(srcCode, yylstack[yysp - 1], yy.options);
        if (ast.fault) {
    ...
    case 52:
        ...
        {
        let rv = yyparser.yyError(rmCommonWS$1`
    ...
    `);
        ...
        this.$ = {
            fault: rv,
            rule: yyvstack[yysp - 1],
        };
        }
        break;

    case 56:
        /*! Production::    rule : action_chunk_at_SOL */
    ...
    case 66:
        /*! Production::    action_chunk_at_SOL : ACTION_START_AT_SOL action_block ACTION_END */
    case 68:
        /*! Production::    action_chunk : ACTION_START action_block ACTION_END */
    ...
    case 67:
        /*! Production::    action_chunk_at_SOL : ENTIRE_ACTION_AT_SOL */
    case 69:
        /*! Production::    action_chunk : ENTIRE_ACTION */
        ...
        {
        if (yyvstack[yysp].fault) {
            this.$ = yyvstack[yysp];
        } else {
            let srcCode = trimActionCode$1(yyvstack[yysp].srcCode, {
                startMarker: yyvstack[yysp].action_start_marker
            });
        
            let ast = checkActionBlock$1(srcCode, yylstack[yysp], yy.options);
            this.$ = {
                ast, 
                fault: ast.fault,
                srcCode
    ...
    case 70:
        /*! Production::    action_block : action_block action */
    case 88:
    ...
    case 71:
        /*! Production::    action_block : %epsilon */
    case 82:
    ...
    case 74:
        /*! Production::    action : INCLUDE_PLACEMENT_ERROR */
    ...
    case 75:
        /*! Production::    action : BRACKET_MISSING */
    ...
    case 76:
        /*! Production::    action : BRACKET_SURPLUS */
    ...
    case 77:
        /*! Production::    action : UNTERMINATED_STRING_ERROR */
    ...
    case 78:
        ...
        this.$ = yyvstack[yysp - 2].map(function (el) {
            ...
            if (name !== '*' && name !== 'INITIAL' && !(name in yy.startConditions)) {
                yyparser.yyError(rmCommonWS$1`
                You specified an unknown lexer condition state ${dquote$2(name)}.
    ...
    case 127:
        ...
        if (yy.__options_flags__ & OPTION_DOES_NOT_ACCEPT_VALUE) {
            yyparser.yyError(rmCommonWS$1`
            The entries in a ${yy.__options_category_description__} statement MUST NOT be assigned values, such as ${dquote$2(yyvstack[yysp - 2] + '=' + yyvstack[yysp])}.
    ...
    case 128:
        ...
        // TODO ...
        yyparser.yyError(rmCommonWS$1`
        Internal error: option ${dquote$2($option)} value assignment failure in a ${yy.__options_category_description__} statement.
    ...
    case 137:
        ...
        if (srcCode) {
            let rv = checkActionBlock$1(srcCode, yylstack[yysp], yy.options);
            if (rv.fault) {
                yyparser.yyError(rmCommonWS$1`
    ...
    case 140:
        /*! Production::    epilogue_chunk : action_chunk_at_SOL */
    ...
    case 145:
        ...
        if (!fs__default['default'].existsSync(include_path)) {
            yyparser.yyError(rmCommonWS$1`
            Cannot %include ${dquote$2(include_path)}:
        ...
        `);
            ...
            if (srcCode) {
                let rv = checkActionBlock$1(srcCode, this._$, yy.options);
                if (rv.fault) {
                    yyparser.yyError(rmCommonWS$1`
                    The source code included from file ${dquote$2(include_path)} does not compile: ${rv.fault}
    ...
    parse: function parse(input) {
        ...
        const NO_ACTION = [ 0, 201 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
    ...
    /*! Conditions:: action */ 
    /*! Rule::       \/(?=\s) */ 
     return 38;       // most probably a `/` divide operator. 
    case 7 : 
    /*! Conditions:: action */ 
    /*! Rule::       \/.* */ 
     {
    ...
    /*! Rule::       {BR}{WS}+(?!(?:{WS}|{BR})) */ 
     yy.include_command_allowed = true;
                                            return 38;           // keep empty lines as-is inside action code blocks. 
    case 14 : 
    /*! Conditions:: action */ 
    /*! Rule::       {BR} */ 
     if (yy.depth > 0) {
    ...
    /*! Conditions:: code */ 
    /*! Rule::       (?:[^%{BR}][^{BR}]*{BR}+)+ */ 
     return 58;      // shortcut to grab a large bite at once when we're sure not to encounter any `%include` in there at start-of-line. 
    case 95 : 
    /*! Conditions:: code */ 
    /*! Rule::       [^{BR}]+ */ 
    ...
    */
    ...
    function prepareRules(dict, actions, caseHelper, tokens, startConditions, grammarSpec) {
        ...
        for (let i = 0; i < rules.length; i++) {
            ...
            assert__default['default'](!m || Array.isArray(m));
            ...
            if (typeof r === 'string') {
                ...
                re = new XRegExp__default['default']('^(?:' + r + ')', grammarSpec.options.caseInsensitive ? 'i' : '');
            }
            ...
            assert__default['default'](!rule.fault || rule.fault instanceof Error);  // when there's a 'fault' reported for this rule, it must be an Error object.
                    ...
                    if (!test_me(function tweakResult_3() {
                        ...
                        try {
                            ...
                            for (let i = rules.length - 1; i >= 0; i--) {
                                ...
                                let rule = rules[i];
                                assert__default['default'](rule != null);
                                assert__default['default'].equal(typeof rule, 'object');
                                assert__default['default']('rule' in rule);
                                assert__default['default']('srcCode' in rule);
                                rule.srcCode = '{ /* nada */ }';
...
`))();
    ...
    function generateESModule(grammarSpec) {
        ...
        if (!grammarSpec.options.noMain) {
            ...
            exportMain = rmCommonWS$2`
            yymain,
            yyExecMain as main,
        `;
            
            invokeMain = rmCommonWS$2`
    ...
    function cliMain(opts) {
        ...
        function processInputFile() {
            ...
            try {
                ...
                fs__default['default'].writeFileSync(opts.outfile, lexer, 'utf8');
                ...
                if (opts.exportAST) {
                    ...
                    mkdirp$1(path__default['default'].dirname(fname));
