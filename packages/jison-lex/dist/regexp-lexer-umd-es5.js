...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert'), require('jison-helpers-lib')) : typeof define === 'function' && define.amd ? define(['@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert', 'jison-helpers-lib'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["regexp-lexer"] = factory(global.XRegExp, global.json5, global.lexParser, global.assert, global.helpers));
})(undefined, function (XRegExp, json5, lexParser, assert, helpers) {
    'use strict';
