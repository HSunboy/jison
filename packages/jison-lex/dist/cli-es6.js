...
function cliMain(opts) {
    ...
    function processInputFile() {
        ...
        let raw = fs.readFileSync(path$1.normalize(opts.file), 'utf8');
        ...
        let name = path$1.basename(opts.outfile || opts.file);
        ...
        let new_cwd = path$1.dirname(path$1.normalize(opts.file));
