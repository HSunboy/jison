...
let predefined_tokens=null;return RegExpLexer.generate(lexerSpec,predefined_tokens,opts);}var cli={main:cliMain,generateLexerString:generateLexerString};if(require.main===module){const opts=getCommandlineOptions();cli.main(opts);}return cli;});
