...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('jison-helpers-lib'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert')) : typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', 'jison-helpers-lib', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fs, global.path, global.nomnom, global.helpers, global.XRegExp, global.json5, global.lexParser, global.assert));
})(undefined, function (fs, path, nomnom, helpers, XRegExp, json5, lexParser, assert) {
    'use strict';
    ...
    //
    // `/\s/`:
    var WHITESPACE_SETSTR = ' \f\n\r\t\x0B\xA0\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF';
    // `/\d/`:
    var DIGIT_SETSTR = '0-9';
    // `/\w/`:
    var WORDCHAR_SETSTR = 'A-Za-z0-9_';
