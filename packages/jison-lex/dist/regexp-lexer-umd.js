(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('fs'), require('path'), require('recast'), require('assert'), require('@gerhobbelt/js-yaml')) :
    typeof define === 'function' && define.amd ? define(['@gerhobbelt/xregexp', '@gerhobbelt/json5', 'fs', 'path', 'recast', 'assert', '@gerhobbelt/js-yaml'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['regexp-lexer'] = factory(global.XRegExp, global.JSON5, global.fs, global.path, global.recast, global.assert, global.yaml));
}(this, (function (XRegExp, JSON5, fs, path, recast, assert$1, yaml) { 'use strict';
