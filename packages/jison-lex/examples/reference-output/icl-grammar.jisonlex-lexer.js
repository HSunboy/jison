...
/*  8: */  /^(?:\bas\b)/i,
/*  9: */  /^(?:\btable\b)/i,
/* 10: */  /^(?:\b([\-A-Z_a-z|])+((\d)|([\-A-Z_a-z|]))*(\.([\-A-Z_a-z|])+((\d)|([\-A-Z_a-z|]))?)+\b)/i,
/* 11: */  /^(?:(?!true|false|null)(::)?\b(([\-A-Z_a-z|])+(\d)*([\-A-Z_a-z|])*)|(true|false|null)(([\-A-Z_a-z|])+(\d)*([\-A-Z_a-z|])*)\b)/i,
/* 12: */  /^(?:(["])\b([\-A-Z_a-z|])+(\d)*([\-A-Z_a-z|])*\b(["]))/i,
/* 13: */  /^(?:((['@]){1,2})(([\-A-Z_a-z|])+(\d)*([\-A-Z_a-z|])*)(\.(([\-A-Z_a-z|])+(\d)*([\-A-Z_a-z|])*))*)/i,
/* 14: */  /^(?:(['@]))/i,
/* 15: */  /^(?:(['<]{3}([A-Z_a-z|]+)(.|\r|\n)*\u0002))/i,
/* 16: */  /^(?:(((?:['+|]?(?:(?:\d)+)[.](?:(?:\d)+))|(?:(?:(?:\d)+)|-(?:(?:\d)+)|\+(?:(?:\d)+)))|(true|false)|(((?=["'])(?:"[^"\\]*(?:\\[\S\s][^"\\]*)*"|'[^'\\]*(?:\\[\S\s][^'\\]*)*')))|(null)))/i,
/* 17: */  /^(?:\{)/i,
/* 18: */  /^(?:\})/i,
/* 19: */  /^(?:(['=]))/i,
/* 20: */  /^(?:(\]))/i,
...
default:
  ...
  rules: [
    ...
    {
      re: '/^(?:\\b([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))*(\\.([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))?)+\\b)/i',
      source: '^(?:\\b([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))*(\\.([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))?)+\\b)',
      flags: 'i',
      xregexp: {
        captureNames: null,
        source: '^(?:\\b([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))*(\\.([\\-A-Z_a-z|])+((\\d)|([\\-A-Z_a-z|]))?)+\\b)',
    ...
    {
      re: '/^(?:(?!true|false|null)(::)?\\b(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)|(true|false|null)(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)\\b)/i',
      source: '^(?:(?!true|false|null)(::)?\\b(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)|(true|false|null)(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)\\b)',
      flags: 'i',
      xregexp: {
        captureNames: null,
        source: '^(?:(?!true|false|null)(::)?\\b(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)|(true|false|null)(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)\\b)',
    ...
    {
      re: '/^(?:(["])\\b([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*\\b(["]))/i',
      source: '^(?:(["])\\b([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*\\b(["]))',
      flags: 'i',
      xregexp: {
        captureNames: null,
        source: '^(?:(["])\\b([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*\\b(["]))',
    ...
    {
      re: "/^(?:((['@]){1,2})(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)(\\.(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*))*)/i",
      source: "^(?:((['@]){1,2})(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)(\\.(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*))*)",
      flags: 'i',
      xregexp: {
        captureNames: null,
        source: "^(?:((['@]){1,2})(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*)(\\.(([\\-A-Z_a-z|])+(\\d)*([\\-A-Z_a-z|])*))*)",
    ...
    {
      re: `/^(?:(((?:['+|]?(?:(?:\\d)+)[.](?:(?:\\d)+))|(?:(?:(?:\\d)+)|-(?:(?:\\d)+)|\\+(?:(?:\\d)+)))|(true|false)|(((?=["'])(?:"[^"\\\\]*(?:\\\\[\\S\\s][^"\\\\]*)*"|'[^'\\\\]*(?:\\\\[\\S\\s][^'\\\\]*)*')))|(null)))/i`,
      source: `^(?:(((?:['+|]?(?:(?:\\d)+)[.](?:(?:\\d)+))|(?:(?:(?:\\d)+)|-(?:(?:\\d)+)|\\+(?:(?:\\d)+)))|(true|false)|(((?=["'])(?:"[^"\\\\]*(?:\\\\[\\S\\s][^"\\\\]*)*"|'[^'\\\\]*(?:\\\\[\\S\\s][^'\\\\]*)*')))|(null)))`,
      flags: 'i',
      xregexp: {
        captureNames: null,
        source: `^(?:(((?:['+|]?(?:(?:\\d)+)[.](?:(?:\\d)+))|(?:(?:(?:\\d)+)|-(?:(?:\\d)+)|\\+(?:(?:\\d)+)))|(true|false)|(((?=["'])(?:"[^"\\\\]*(?:\\\\[\\S\\s][^"\\\\]*)*"|'[^'\\\\]*(?:\\\\[\\S\\s][^'\\\\]*)*')))|(null)))`,
  ...
  macros: {
    ...
    UNICODECHAR: {
      in_set: '\\\\',
      elsewhere: '\\\\u(?:[\\da-f])(?:[\\da-f])(?:[\\da-f])(?:[\\da-f])',
      raw: '\\\\u{HEX_DIGIT}{HEX_DIGIT}{HEX_DIGIT}{HEX_DIGIT}',
    },
    CHAR: {
      in_set: ' \\\\',
      elsewhere: '(?:[ !#-\\[\\]-~])|(?:\\\\["/\\\\bfnrt])|(?:\\\\u(?:[\\da-f])(?:[\\da-f])(?:[\\da-f])(?:[\\da-f]))',
