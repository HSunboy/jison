...
EOF: 1,
  ...
  parser.pre_parse = function(yy) {
    print(
      'parsing: ',
      yy.lexer.upcomingInput(-1 /* i.e. produce the entire (unparsed) input string */)
    );
  ...
  function bench(f, n, minimum_run_time, setup_f, destroy_f) {
    ...
    console.log([
      ...
      cnt * sample_size,
      ', # runs/sec: ',
      r(cnt * sample_size * 1000 / sum, 1),
      ', average: ',
      r(avg / sample_size, 4) + 'ms',
      ', deviation: ',
      r(100 * dev / avg, 2) + '%',
      ', peak_deviation: ',
      r(100 * peak / avg, 2) + '%',
  ...
  parser.main = function() {
    ...
    function test() {
      const formulas_and_expectations = [
        basenum + '+2*(3-5--+--+6!)-7/-8%',
        1523.5 + basenum,
        basenum + '+2*0.7%^PI^2+4+5',
        9 + basenum,
        /* this bets on JS floating point calculations discarding the small difference with this integer value... */
        basenum + '+(2+3*++++)+5+6+7+8+9 9',
        // with error recovery and all it gives you a value...
        74 + basenum,
        basenum + '+2*(3!-5!-6!)/7/8',
        -29.785714285714285 + basenum
      ];
