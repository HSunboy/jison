...
/*  5: */  /^(?:(@[Ss][Tt][Aa][Rr][Tt]))/,
/*  6: */  /^(?:([Ss][Pp][Aa][Rr][Qq][Ll]))/,
/*  7: */  /^(?:(@(?:(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.)*(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀]))?)?:)(?:((?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|:|\d|(?:(?:%(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))|(?:\\(_|~|\.|-|!|\$|&|'|\(|\)|\*|\+|,|;|=|\/|\?|#|@|%))))((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.|:|(?:(?:%(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))|(?:\\(_|~|\.|-|!|\$|&|'|\(|\)|\*|\+|,|;|=|\/|\?|#|@|%))))*))))/,
/*  8: */  /^(?:(@(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.)*(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀]))?)?:)))/,
/*  9: */  /^(?:(@([A-Za-z])+((-([^\W_])+))*))/,
/* 10: */  /^(?:((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.)*(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀]))?)?:)(?:((?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|:|\d|(?:(?:%(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))|(?:\\(_|~|\.|-|!|\$|&|'|\(|\)|\*|\+|,|;|=|\/|\?|#|@|%))))((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.|:|(?:(?:%(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))|(?:\\(_|~|\.|-|!|\$|&|'|\(|\)|\*|\+|,|;|=|\/|\?|#|@|%))))*)))/,
/* 11: */  /^(?:(appinfo:))/,
...
/* 17: */  /^(?:(_:((?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|\d)(((?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀])|\.)*(?:(?:(?:[A-Z]|[a-z]|[À-Ö]|[Ø-ö]|[ø-˿]|[Ͱ-ͽ]|[Ϳ-῿]|[‌‍]|[⁰-↏]|[Ⰰ-⿯]|[、-퟿]|[豈-﷏]|[ﷰ-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])|_|_)|-|\d|[·]|[̀-ͯ]|[‿⁀]))?))/,
/* 18: */  /^(?:('''(('|'')?([^'\\]|(?:\\["'\\bfnrt])|(?:\\u(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])|\\U(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))))*'''))/,
/* 19: */  /^(?:("""(("|"")?([^"\\]|(?:\\["'\\bfnrt])|(?:\\u(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])|\\U(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f]))))*"""))/,
/* 20: */  /^(?:('([^\n\r'\\]|(?:\\["'\\bfnrt])|(?:\\u(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])|\\U(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])))*'))/,
/* 21: */  /^(?:("([^\n\r"\\]|(?:\\["'\\bfnrt])|(?:\\u(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])|\\U(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])(?:\d|[A-F]|[a-f])))*"))/,
/* 22: */  /^(?:a)/,
/* 23: */  /^(?:,)/,
...
const lexerSpecConglomerate = {
  ...
  lex_rule_dictionary: {
    rules: [
      ...
      [
        '{APPINFO_SPACE_COLON}',
        "return 'APPINFO_SPACE_COLON'",
      ],
      [
        '{STRING_LITERAL2_COLON}',
        "return 'STRING_LITERAL2_COLON'",
      ],
      [
        '{FOCUS}',
        "return 'IT_FOCUS'",
