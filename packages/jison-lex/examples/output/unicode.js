...
const lexer = function() {
  ...
  // Included by Jison: includes/unicode.helpers.js:
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 4:
        ...
        if (rv) {
          ...
          if (rv.opcode) {
            yy_.yytext = new ASTopcode(rv.opcode).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(rv.name);
          } else if (rv.lexer_opcode) {
            yy_.yytext = new lexerToken(rv.lexer_opcode).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(rv.name);
          }
        ...
        if (rv) {
          yy_.yytext = new ASTcurrency(rv).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(s);
          return 'CURRENCY';
        }
        ...
        if (rv) {
          yy_.yytext = new ASTvalue(rv.value, rv.attributes).setPredefinedConstantInfo(rv).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(s);
      ...
      case 5:
        ...
        yy_.yytext = new ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_2039).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      case 6:
        /*! Conditions:: INITIAL */
        ...
        yy_.yytext = new ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_201C).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      case 7:
        /*! Conditions:: INITIAL */
        ...
        yy_.yytext = new ASTvalue(s, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_00AB).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      case 8:
        /*! Conditions:: INITIAL */
        ...
        yy_.yytext = new ASTvalue(s2, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_SINGLEQUOTE).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      case 9:
        /*! Conditions:: INITIAL */
        ...
        var s2 = parser.dedupQuotedString(s, '"');
        yy_.yytext = new ASTvalue(s2, FKW_VALUE | FT_STRING | FU_STRING).setNotationAttributes(FKA_DELIMITERS_DOUBLEQUOTE).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex());
        return 'STRING';
        break;
      case 10:
      ...
      case 13:
        ...
        yy_.yytext = new ASTerror(FERR_UNTERMINATED_INLINE_COMMENT, 'Unterminated inline comment.').setErrorArguments(this.inline_comment_end_markers).setLocationInfo(yy_.yylloc).setCommentsIndex(parser.getNextCommentIndex()).setLexedText(yy_.yytext);
        return 'error';
        break;
      case 19:
        /*! Conditions:: INITIAL */
