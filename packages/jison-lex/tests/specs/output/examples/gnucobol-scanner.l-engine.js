...
in JISON Mode we get Error: Lexical error on line 399: 
...
399: <*>;+ {
^^^.....^
400:  if (inside_bracket) {
401:   RETURN_TOK (SEMI_COLON);


while JSON5 Mode produces Error: JSON5: invalid character '%' at 27:1`,
    type: 'Error',
    stack: `SyntaxError: JSON5: invalid character '%' at 27:1
