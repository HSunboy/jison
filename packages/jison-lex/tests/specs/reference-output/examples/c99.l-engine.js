...
/*  48: */  /^(?:((0[xX]))([a-fA-F0-9])+((((u|U)(l|L|ll|LL)?)|((l|L|ll|LL)(u|U)?)))?)/,
/*  49: */  /^(?:([1-9])([0-9])*((((u|U)(l|L|ll|LL)?)|((l|L|ll|LL)(u|U)?)))?)/,
/*  50: */  /^(?:0([0-7])*((((u|U)(l|L|ll|LL)?)|((l|L|ll|LL)(u|U)?)))?)/,
/*  51: */  /^(?:((u|U|L))?'([^'\\\n]|((\\(['"\?\\abfnrtv]|[0-7]{1,3}|x[a-fA-F0-9]+))))+')/,
/*  52: */  /^(?:([0-9])+(([Ee][+-]?(?:[0-9])+))((f|F|l|L))?)/,
/*  53: */  /^(?:([0-9])*\.([0-9])+(([Ee][+-]?(?:[0-9])+))?((f|F|l|L))?)/,
/*  54: */  /^(?:([0-9])+\.(([Ee][+-]?(?:[0-9])+))?((f|F|l|L))?)/,
/*  55: */  /^(?:((0[xX]))([a-fA-F0-9])+(([Pp][+-]?(?:[0-9])+))((f|F|l|L))?)/,
/*  56: */  /^(?:((0[xX]))([a-fA-F0-9])*\.([a-fA-F0-9])+(([Pp][+-]?(?:[0-9])+))((f|F|l|L))?)/,
/*  57: */  /^(?:((0[xX]))([a-fA-F0-9])+\.(([Pp][+-]?(?:[0-9])+))((f|F|l|L))?)/,
