...
/*  1: */  /^(?:^take)/i,
/*  2: */  /^(?:([,]))/i,
/*  3: */  /^(?:((\$\/)*((([a-z|A-Z|_|\-|0-9])|[.]{1,2})+)(\/(([a-z|A-Z|_|\-|0-9])+|[.]{1,2}))*))/i,
/*  4: */  /^(?:([\n|\r])+)/i,
/*  5: */  /^(?:[\s|\r\n|\r|\n]+)/i,
/*  6: */  /^(?:\bfrom\b)/i,
/*  7: */  /^(?:\bapply\b)/i,
/*  8: */  /^(?:\bas\b)/i,
/*  9: */  /^(?:\btable\b)/i,
/* 10: */  /^(?:\b([a-z|A-Z|_|\-])+(([0-9])|([a-z|A-Z|_|\-]))*(\.([a-z|A-Z|_|\-])+(([0-9])|([a-z|A-Z|_|\-]))?)+\b)/i,
/* 11: */  /^(?:(?!true|false|null)(::)?\b(([a-z|A-Z|_|\-])+([0-9])*([a-z|A-Z|_|\-])*)|(true|false|null)(([a-z|A-Z|_|\-])+([0-9])*([a-z|A-Z|_|\-])*)\b)/i,
/* 12: */  /^(?:(["])\b([a-z|A-Z|_|\-])+([0-9])*([a-z|A-Z|_|\-])*\b(["]))/i,
/* 13: */  /^(?:((['@']){1,2})(([a-z|A-Z|_|\-])+([0-9])*([a-z|A-Z|_|\-])*)(\.(([a-z|A-Z|_|\-])+([0-9])*([a-z|A-Z|_|\-])*))*)/i,
/* 14: */  /^(?:(['@']))/i,
/* 15: */  /^(?:(['<']{3}([a-z|A-Z|_]+)(.|\r|\n)*\u0002))/i,
/* 16: */  /^(?:(((?:['+'|'-']?(?:(?:[0-9])+)[.](?:(?:[0-9])+))|(?:(?:(?:[0-9])+)|-(?:(?:[0-9])+)|\+(?:(?:[0-9])+)))|(true|false)|(((?=[\"\'])(?:"[^\"\\]*(?:\\[\s\S][^\"\\]*)*"|'[^\'\\]*(?:\\[\s\S][^\'\\]*)*')))|(null)))/i,
/* 17: */  /^(?:\{)/i,
/* 18: */  /^(?:\})/i,
/* 19: */  /^(?:(['=']))/i,
/* 20: */  /^(?:(\]))/i,
