{
  error: {
    message: `
The lexer rule's action code section does not compile: Error: Line 9: Unexpected token %
    
  Erroneous area:
 9: "a" return a %% return 1;
^^.....^^^^^^^^^^^^^^^^^^^^^^
10:   //
^^..^^^^
11: 
...
12: 
    ...
    at Object.parser__PerformAction (/regexp-lexer-cjs.js:4502:18)
