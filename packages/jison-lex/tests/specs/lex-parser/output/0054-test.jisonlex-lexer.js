...
/*! Conditions:: INITIAL */ 
/*! Rule::       foo */ 
 yy_.yytext += `:${yy.options.s2}:${yy.options.aBC}:${yy.options.bool1}:${yy.options.bla}:${yy.options.s1}`; return 11 
break;
}
        },
...
const lexerSpecConglomerate = {
  ...
  lex_rule_dictionary: {
    rules: [
      [
        'foo',
        'yytext += `:${yy.options.s2}:${yy.options.aBC}:${yy.options.bool1}:${yy.options.bla}:${yy.options.s1}`; return 11',
      ],
    ],
    macros: {},
    startConditions: {},
