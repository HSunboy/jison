(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('recast'), require('@babel/core'), require('assert')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', 'recast', '@babel/core', 'assert'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['jison-helpers-lib'] = factory(global.fs, global.path$1, global.recast, global.babel, global.assert));
}(this, (function (fs, path$1, recast, babel, assert) { 'use strict';
