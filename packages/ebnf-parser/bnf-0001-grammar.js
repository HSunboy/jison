...
case 1:
    /*! Production::    spec : declaration_list "%%" grammar EOF */

    this.$ = yyvstack[yysp - 3]; this.$.bnf = yyvstack[yysp - 1]; return this.$
    break;
...
case 19:
    /*! Production::    handle : handle symbol */
...
case 13:
    ...
    this.$ = yyvstack[yysp - 1]; this.$[yyvstack[yysp][0]] = yyvstack[yysp][1]
    break;
...
case 18:
    /*! Production::    handle_action : handle action prec */

    this.$ = [(yyvstack[yysp - 2].length ? yyvstack[yysp - 2].join(' ') : '')]; if(yyvstack[yysp - 1]) this.$.push(yyvstack[yysp - 1]); if(yyvstack[yysp]) this.$.push(yyvstack[yysp]); if (this.$.length === 1) this.$ = this.$[0]
    break;
...
parse: function parse(input) {
    ...
    const NO_ACTION = [ 0, 37 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = bnf_0001Grammar;
  exports.Parser = bnf_0001Grammar.Parser;
  exports.parse = function () {
    return bnf_0001Grammar.parse.apply(bnf_0001Grammar, arguments);
  };
