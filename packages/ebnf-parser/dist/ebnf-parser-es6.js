    ...
    return production.map(function (handle) {
        ...
        if (action) {
            ...
            if (list.first_transformed_term_index) {
                ...
                let alias_re = new XRegExp(`\\[${ID_REGEX_BASE$1}\\]`);
                let term_re = new XRegExp(`^${ID_REGEX_BASE$1}$`);
                ...
                //
                let nameref_re = new XRegExp(`(?:[$@]|##)${ID_REGEX_BASE$1}`, 'g');
...
case 127:
    ...
    {
    let fileContent = fs.readFileSync(yyvstack[yysp], { encoding: 'utf-8' });
