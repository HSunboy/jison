...
clean-dumpfiles:
	bash -c "find . -type f \( -iname '*fatal_*_dump*' -o -ipath '*reference-output*' -o -ipath '*/examples/output/*' -o -ipath '*/lex/output/*' -o -ipath '*/specs/output/*' -o -ipath '*/specs/**/output/*' \) -print -delete"
