...
//_handle_error_with_recovery:                // run this code when the grammar includes error recovery rules
                ...
                if (!action) {
                    ...
                    ASSERT(recoveringErrorInfo, 'Line 1207');
                    ASSERT(symbol === TERROR, 'Line 1208');
                    ASSERT(!action, 'Line 1209');
                    ...
                    for (;;) {
                        ...
                        if (this.defaultActions[state]) {
                            ...
                            if (!action) {
                                ...
                                ASSERT(recoveringErrorInfo, 'Line 1251');
                        ...
                        case 1:
                            ...
                            ASSERT(preErrorSymbol === 0, 'Line 1386');
                            if (recovering === 0) {
                                break;
                            }
                            continue;
...
//_handle_error_end_of_section:                  // this concludes the error recovery / no error recovery code section choice above
            ...
            case 1:
                ...
                ASSERT(preErrorSymbol === 0, 'Line 1622');         // normal execution / no error
                ASSERT(recovering === 0, 'Line 1623');             // normal execution / no error
            ...
            // reduce:
            case 2:
                ASSERT(preErrorSymbol === 0, 'Line 1634');         // normal execution / no error
                ASSERT(recovering === 0, 'Line 1635');             // normal execution / no error
