...
//_handle_error_with_recovery:                // run this code when the grammar includes error recovery rules
                ...
                if (!action) {
                    ...
                    if (error_rule_depth < 0) {
                        ...
                        // while we are still busy recoveringSymbolShiftCounter from another error:
                    ...
                    // *or* we run into another error while recoveringSymbolShiftCounter from this one
                    ...
                    ASSERT(recoveringErrorInfo, 'Line 1255');
                    ASSERT(symbol === TERROR, 'Line 1256');
                    ASSERT(!action, 'Line 1257');
                    ...
                    for (;;) {
                        ...
                        if (this.defaultActions[state]) {
                            ...
                            if (!action) {
                                if (yydebug) yydebug('**NESTED ERROR DETECTED** while still recoveringSymbolShiftCounter from previous error');

                                ASSERT(recoveringErrorInfo, 'Line 1299');
                        ...
                        case 1:
                            ...
                            if (symbol === TERROR && errorSymbolFromParser) {
                                ...
                                // error we're recoveringSymbolShiftCounter from.
                                ASSERT(recoveringErrorInfo, 'Line 1356');
                                vstack[sp] = recoveringErrorInfo;
                                lstack[sp] = this.yyMergeLocationInfo(null, null, recoveringErrorInfo.loc, lexer.yylloc, true);
                            } else {
                                ASSERT(symbol !== 0, 'Line 1360');
                                ASSERT(preErrorSymbol === 0, 'Line 1361');
                            ...
                            if (!preErrorSymbol) { // normal execution / no error
                                ...
                                if (!t[0] || symbol === TERROR) {
                                    ...
                                    // recoveringSymbolShiftCounter from now...
                                    //
